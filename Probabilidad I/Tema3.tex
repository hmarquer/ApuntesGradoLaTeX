...
\begin{ejem}
	...
	% 				                              & \stackrel{\tex{HI}}{=} \int_{-\infty}^{\infty} \frac{1}{\sqrt{2\pi}(n-1)} e^{-\frac{u^2}{2(n-1)}} \cdot \frac{1}{\sqrt{2\pi}} e^{-\frac{(z-u)^2}{2}} \odif{u} \\
	% 				                              & = \frac{1}{\sqrt{2\pi}(n-1)} \frac{1}{\sqrt{2\pi}} \int_{-\infty}^{\infty} e^{-\frac{1}{2}\left[\frac{u^2}{n-1} + \left(z-u\right)^2\right]} \odif{u}         \\
	% 			\end{aligned}\]
	% 		Completamos cuadrados: $\ds -\frac{1}{2}\left[\frac{u^2}{n-1} + \left(z-u\right)^2\right] = -\frac{1}{2}\left[\frac{u^2}{n-1} + z^2 - 2uz + u^2\right]$
	% 		\[= -\frac{1}{2}\left[u^2\left(\frac{1}{n-1} + 1\right) - 2uz + \frac{z^2}{n} + \frac{n-1}{n}z^2\right] = -\frac{1}{2} \left(u^2\frac{n}{n-1} -2uz + \frac{n-1}{n}z^2\right) - \frac{z^2}{2n}\]
