...
\allbold{13.} Sean $(X_1, X_2) \sim$ normal bidimensional con $\mu_1, \mu_2, \sigma_1, \sigma_2, \rho$. Hacemos el cambio de variable $Z_1 \defeq \frac{X_1-\mu_1}{\sigma_1} \we Z_2 \defeq \frac{X_2-\mu_2}{\sigma_2}$: %TODO: ver que sale (Z_1, Z_2) ~ normal bidimensional (0, 1, \rho)

\allbold{14.} Sean $X, Y \sim \normal{0, 1}$ independientes. Definimos $W\defeq 2X-Y$ y queremos ver que $W\sim\normal{0, 5}$.
\[f_{X, Y} (x,y) = \frac{1}{2\pi} e^{-\frac{x^2+y^2}{2}}\]
Hacemos el cambio de variable $U = X \we W=2X-Y$ y sale %TODO: terminar
