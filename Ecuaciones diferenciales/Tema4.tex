	...
	\begin{itemize}
		...
		\item $\lambda_2 = i$ : $\begin{pmatrix}
			      ...
			      \end{pmatrix} \implies \begin{cases}
				      \xi_2 = (\hphantom{-}i, 1, 1+i) \\
				      \overline{\xi_2} = (-i, 1, 1-i) \\
			      \end{cases}$.
		      \[\implies \begin{cases}
				      X_2(t) = \xi_2 e^{it\hphantom{-}} = (\hphantom{-}i, 1, 1+i) e^{it} \\
...
Como vimos, $e^J$ es también una matriz por bloques de la forma $e^{J_i}$ donde $J_i$ son los bloques de $J$ de la forma $J_i = \alpha_i I + N_i$.
