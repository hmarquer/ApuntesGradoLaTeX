...
\begin{ejem}
	...
	\end{enumerate}
	\ifdraft{\vspace{5cm}}{\input{graphs/graph1}}
\end{ejem}
...
\begin{ejem}\mbox{}\\
	...
	\begin{tabular}{cc}
		...
		%\input{slopefield1} & \input{slopefield2}
		\ifdraft{\framebox(7cm,7cm){} & \framebox(7cm,7cm){}}{\input{graphs/slopefield1} & \input{graphs/slopefield2}}
	\end{tabular}
\end{ejem}
...
\begin{ejem}[$x'=x^2-t^2$]
	...
	\end{enumerate}
	\input{graphs/slopefield4 copy.tex}
\end{ejem}
...
\begin{ejem}[$x'=x^2\arctan(x)$]
	\begin{enumerate}
		...
		\item $\sup(I)<\infty$
		      ...
		      \end{dem}
	\end{enumerate}
	\input{graphs/slopefield4 copy 2.tex}
\end{ejem}